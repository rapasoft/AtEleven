...
class FoodAnnotationFilter : DailyMenuFilter {
    ...
    val annotationList = arrayListOf(
            ...
            FoodAnnotation("hovadzie", """(hov[ä|a]dz.*)""".toRegex(RegexOption.IGNORE_CASE), "{\"backgroundColor\": \"darkred\", \"color\": \"white\"}"),
            FoodAnnotation("bravcove", """(brav[c|č]ov.*)""".toRegex(RegexOption.IGNORE_CASE), "{\"backgroundColor\": \"pink\"}"),
            FoodAnnotation("hamburger", """(hamburg.*)""".toRegex(RegexOption.IGNORE_CASE), "{\"backgroundColor\": \"mediumvioletred\", \"color\": \"white\"}"),
            FoodAnnotation("pizza", """(pizza.*)""".toRegex(RegexOption.IGNORE_CASE), "{\"backgroundColor\": \"darkorange\"}"),
            FoodAnnotation("cestoviny",
                    """(cestovin.*|penne|[š|]pagh{0,1}ett{0,1}[i|y]|tagliatelle|bulgur|gnocchi|la[s|z]ag{0,1}ne)"""
